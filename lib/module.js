...
module.exports = exports = class Module {
  ...
  _createModule(source) {
    this._id = binding.createModule(Module, this, this.url.href, source, 0)

    records.set(this._id, this)
  }

  _createSyntheticModule(names) {
    this._id = binding.createSyntheticModule(Module, this, this.url.href, names)
  ...
  _runModule() {
    return binding.runModule(Module, this, onrun)
  }
...
binding.init(exports, onimport, onevaluate, onmeta)
