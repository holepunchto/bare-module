...
async function driveAsync(generator, protocol) {
  ...
  while (next.done !== true) {
    ...
    if ('module' in next.value) {
      value = readAsync(protocol, next.value.module)
    } else if ('probe' in next.value) {
      value = existsAsync(protocol, next.value.probe)
    } else if ('resolution' in next.value) {
      value = resolveAsync(protocol, next.value.resolution)
    } else {
      value = listAsync(protocol, next.value.prefix)
    }
