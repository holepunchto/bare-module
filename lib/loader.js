...
function driveSync(generator, protocol, driveLink) {
  ...
  while (next.done !== true) {
    ...
    if ('module' in command) {
      ...
      value = existsSync(protocol, command.probe)
    } else if ('resolution' in command) {
      value = resolveSync(protocol, command.resolution)
    } else {
  ...
  while (next.done !== true) {
    ...
    try {
      if ('module' in command) {
        ...
        value = existsAsync(protocol, command.probe)
      } else if ('resolution' in command) {
        value = resolveAsync(protocol, command.resolution)
      } else {
