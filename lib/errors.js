module.exports = class ModuleError extends Error {
  ...
  static ADDON_NOT_FOUND(msg, specifier, referrer = null, candidates = []) {
    const err = new ModuleError(msg, ModuleError.ADDON_NOT_FOUND)
  ...
  static PROTOCOL_INCOMPATIBLE(msg) {
    return new ModuleError(msg, ModuleError.PROTOCOL_INCOMPATIBLE)
  }

  static CACHE_INCOMPATIBLE(msg) {
    return new ModuleError(msg, ModuleError.CACHE_INCOMPATIBLE)
  }
  ...
  static UNEXPECTED_PROMISE(msg) {
    return new ModuleError(msg, ModuleError.UNEXPECTED_PROMISE)
  }

  static UNKNOWN_MODULE_TYPE(msg) {
    return new ModuleError(msg, ModuleError.UNKNOWN_MODULE_TYPE)
  }
}
