module.exports = class ModuleError extends Error {
  ...
  static MODULE_NOT_FOUND(msg, candidates = []) {
    const err = new ModuleError(msg, 'MODULE_NOT_FOUND', ModuleError.MODULE_NOT_FOUND)
  ...
  static INVALID_IMPORTS_MAP(msg) {
    return new ModuleError(msg, 'INVALID_IMPORTS_MAP', ModuleError.INVALID_IMPORTS_MAP)
  }
